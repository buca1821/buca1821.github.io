(function () {
  var translations = {
    en: {
      ...
      stackLanguages: "Swift \u00b7 legacy: Objective-C",
      stackUI: "SwiftUI, UIKit",
      stackArch: "MVVM, Clean Architecture, Modular SPM (50+ feature modules), Dependency Injection, Coordinators",
      stackConcurrency: "async/await \u00b7 legacy: Combine, RxSwift, GCD",
      stackNetworking: "URLSession + async/await, third-party API integration (Strava, Tesla Fleet)",
      stackPersistence: "UserDefaults, Keychain, SwiftData, Core Data",
      stackAppleFrameworks: "HealthKit, MapKit, Swift Charts, WorkoutKit, Foundation Models, Vision (OCR)",
      stackPlatform: "Push notifications (APNs), deep linking / Universal Links, biometric auth (FaceID/TouchID), advanced localisation (String Catalogs)",
      stackAnalytics: "Firebase Analytics, Crashlytics, VantageSDK",
      stackTesting: "Swift Testing, XCTest, Unit Tests, Snapshot Testing, Integration Tests",
      stackTooling: "Xcode, Git (GitHub, GitLab), Fastlane, SPM",
      stackCICD: "GitLab CI, GitHub Actions, Xcode Cloud",
      ...
      stackLblNetworking: "Networking", stackLblPersistence: "Persistence", stackLblAppleFrameworks: "Apple Frameworks",
      stackLblPlatform: "Platform", stackLblAnalytics: "Analytics",
      stackLblTesting: "Testing", stackLblTooling: "Tooling", stackLblCICD: "CI/CD", stackLblAI: "AI"
    },
    es: {
      ...
      stackLanguages: "Swift \u00b7 legacy: Objective-C",
      stackUI: "SwiftUI, UIKit",
      stackArch: "MVVM, Clean Architecture, SPM modular (50+ feature modules), Dependency Injection, Coordinators",
      stackConcurrency: "async/await \u00b7 legacy: Combine, RxSwift, GCD",
      stackNetworking: "URLSession + async/await, integraci\u00f3n con APIs de terceros (Strava, Tesla Fleet)",
      stackPersistence: "UserDefaults, Keychain, SwiftData, Core Data",
      stackAppleFrameworks: "HealthKit, MapKit, Swift Charts, WorkoutKit, Foundation Models, Vision (OCR)",
      stackPlatform: "Push notifications (APNs), deep linking / Universal Links, biometric auth (FaceID/TouchID), localizaci\u00f3n avanzada (String Catalogs)",
      stackAnalytics: "Firebase Analytics, Crashlytics, VantageSDK",
      ...
      stackLblNetworking: "Networking", stackLblPersistence: "Persistencia", stackLblAppleFrameworks: "Apple Frameworks",
      stackLblPlatform: "Plataforma", stackLblAnalytics: "Analytics",
      stackLblTesting: "Testing", stackLblTooling: "Herramientas", stackLblCICD: "CI/CD", stackLblAI: "IA"
    }
  };

(function () {
  var translations = {
    ...
    es: {
      ...
      aiP6: "No se trata de reemplazar el criterio ingenieril \u2014 se trata de amplificarlo. El oficio sigue importando. La IA simplemente te permite llegar m\u00e1s lejos.",

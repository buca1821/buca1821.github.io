(function () {
  var translations = {
    en: {
      ...
      aboutP2: "Outside of work, I also build my own projects, using AI as a multiplier across every phase of development: architecture, implementation, design, testing, localization, CI/CD, market research, and App Store preparation.",
    ...
    es: {
      ...
      aboutP2: "Adem\u00e1s, construyo mis propios proyectos, usando IA como multiplicador en cada fase del desarrollo: arquitectura, implementaci\u00f3n, dise\u00f1o, testing, localizaci\u00f3n, CI/CD, estudio de mercado y preparaci\u00f3n para App Store.",
